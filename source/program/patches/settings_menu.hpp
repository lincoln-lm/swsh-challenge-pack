...
static const std::map<u64, std::function<const char16_t*()>> custom_messages = {
    ...
    TOGGLE_MESSAGE("option_trainer_level_boost", "Toggle trainer level boost", save_file.trainer_rng.level_boost),
    ...
    TOGGLE_MESSAGE("option_wild_level_boost", "Toggle wild level boost", save_file.wild_rng.level_boost),
