...
static const std::map<u64, std::function<const char16_t*()>> custom_messages = {
    ...
    TOGGLE_MESSAGE("option_trainer_level_boost", "Toggle 1.25x trainer level", save_file.trainer_rng.level_boost),
    ...
    TOGGLE_MESSAGE("option_wild_level_boost", "Toggle 1.25x wild level", save_file.wild_rng.level_boost),
    ...
    TOGGLE_MESSAGE("option_level_cap_boost", "Toggle 1.25x level cap", save_file.level_cap_boost.enabled),
